...
2. Run **Phase 01 Intake & Plan** from `methodology/phases/phase-01-intake-plan.md`.
3. Run **Phase 02 Profile & Surface** from `methodology/phases/phase-02-profile-surface.md`.
4. Run **Phase 03 Threat & Static Detection** from `methodology/phases/phase-03-threat-and-static.md`.
5. Run **Phase 04 Verification Gate** from `methodology/phases/phase-04-verification-gate.md`.
6. Run **Phase 05 RCA, Variant, Patch** from `methodology/phases/phase-05-rca-variant-patch.md`.
7. Run **Phase 06 Report & Regression** from `methodology/phases/phase-06-report-regression.md`.
